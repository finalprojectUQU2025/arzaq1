...
class VerificationForgetCodeScreen extends StatefulWidget {
  const VerificationForgetCodeScreen({Key? key,required this.email,required this.code}) : super(key: key);
 final String email;
 final String code;
  @override
  State<VerificationForgetCodeScreen> createState() => _VerificationForgetCodeScreenState();
}

class _VerificationForgetCodeScreenState extends State<VerificationForgetCodeScreen> {
  ...
  Future<void> _sendCode() async {
    ApiResponse apiResponse = await AuthApiController().checkCodeForget(
        email: widget.email,
    ...
    if (apiResponse.success) {
      ...
      Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => ResetPasswordScreen(email: widget.email),), (route) => false,);
    } else {
