        ...
        bottomNavigationBar:  Padding(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                boxShadow: [
                  BoxShadow(color: Colors.black.withOpacity(0.08),offset: const Offset(0, 8),blurRadius: 8)
                ]
              ),
                child: Column(
                  ...
                  children: [
                   /* CountdownTimer(
                    ...
                    Container(
                      decoration: BoxDecoration(
                        color: Colors.white,
                        borderRadius: const BorderRadiusDirectional.only(bottomEnd: Radius.circular(8.0),bottomStart: Radius.circular(8.0)),
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              Visibility(
                                visible: _page==2,
                                  child: AppText(text: 'مبيعاتي',fontSize: 12,fontWeight: FontWeight.w500,height: 0.h,)),
                              Visibility(
                                visible: _page==3,
